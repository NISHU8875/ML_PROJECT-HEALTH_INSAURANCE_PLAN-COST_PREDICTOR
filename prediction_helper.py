...
############
# print("Young model feature names:", model_young.feature_names_in_)
# print("Old model feature names:", model_old.feature_names_in_)
##########
...
def preprocess_input(input_dict):
    ...
    expected_columns = [
        'age', 'number_of_dependants', 'income_lakhs','genetical_risk', 'normalized_risk_score', 'insurance_plan_score',
    ...
    for key, value in input_dict.items():
        if key == 'Gender' and value == 'Male':
            ...
            df['insurance_plan_score'] = insurance_plan_encoding.get(value, 1)
...
def handle_scaling(age, df):
    ...
    df['income_level_score'] = None # since scaler object expects income_level_score supply it. This will have no impact on anything
    df[cols_to_scale] = scaler.transform(df[cols_to_scale])

    df.drop('income_level_score', axis='columns', inplace=True)
